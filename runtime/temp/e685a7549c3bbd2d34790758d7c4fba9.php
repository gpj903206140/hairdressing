<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:51:"template/adminblue\Distributionnew\intercalate.html";i:1532582071;s:28:"template/adminblue\base.html";i:1546935702;s:45:"template/adminblue\controlCommonVariable.html";i:1530933188;s:32:"template/adminblue\urlModel.html";i:1531183408;s:34:"template/adminblue\pageCommon.html";i:1538099192;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>是否开启分销：</dt>
		<dd>
			<input id="is_distribution_enable" type="checkbox" class="checkbox" <?php if($set['is_open'] == 1): ?>checked="checked"<?php endif; ?>/>
	...
	<dl>
		<dt>推广员是否需要申请: </dt>
		<dd>
			<input id="is_distribution_audit" type="checkbox" class="checkbox"  <?php if($set['is_audit'] == 1): ?>checked="checked"<?php endif; ?>/>
	...
	<dl>
		<dt>推广申请是否需要审核: </dt>
		<dd>
			<input id="is_distribution_start" type="checkbox" class="checkbox"  <?php if($set['is_start'] == 1): ?>checked="checked"<?php endif; ?>/>
	...
	<dl>
		<dt>批量设置为推广员: </dt>
		<dd>
			<input id="is_distribution_set" type="checkbox" class="checkbox"  <?php if($set['is_set'] == 1): ?>checked="checked"<?php endif; ?>/>
	...
	<dl>
		...
		<dd>		
            <label class="radio inline normal">
            	<i class="radio-common <?php if($set['distribution_use'] == 0): ?>selected<?php endif; ?>">
            		<input type="radio" name="distribution_use" value="0" id="distribution_use_yes"  <?php if($set['distribution_use'] == 0): ?>checked="checked"<?php endif; ?>/>
        		</i>
            	<span>使用利润</span>
            </label> 
		    <label class="radio inline normal">
		    	<i class="radio-common <?php if($set['distribution_use'] == 1): ?>selected<?php endif; ?>">
		    		<input type="radio" name="distribution_use" value="1" id="distribution_use_no"  <?php if($set['distribution_use'] == 1): ?>checked="checked"<?php endif; ?>>
	    		</i>
		    	<span>销售价格</span>
		    </label> 
		</dd>
...
function addIntercalate(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/Distributionnew/intercalate'); ?>",
		data:{
			'is_open':is_open,
			'is_audit':is_audit,
			'is_start':is_start,
		...
		success:function (data) {
			if (data["code"] > 0) {
				showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/Distributionnew/intercalate'); ?>");
			}else{
