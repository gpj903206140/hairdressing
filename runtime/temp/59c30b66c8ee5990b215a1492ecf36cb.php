<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:46:"template/adminblue\Course\courseGroupList.html";i:1545010065;s:28:"template/adminblue\base.html";i:1545011442;s:45:"template/adminblue\controlCommonVariable.html";i:1530933188;s:32:"template/adminblue\urlModel.html";i:1531183408;s:34:"template/adminblue\pageCommon.html";i:1538099192;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="options-btn">
	...
	<button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/course/addcoursegroup'); ?>';">添加课程标签</button>
</div>
...
$(".table-class input.input-common").live("change",function(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/course/modifycoursegroupfield'); ?>",
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type:"post",
					url:"<?php echo __URL('ADMIN_MAIN/course/deletecoursegroup'); ?>",
					data:{'group_id':group_id.toString()},
					dataType : "json",
					success:function (data) {
						if(data['code'] > 0){
							showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/course/coursegrouplist'); ?>");
						}else{
...
function LoadingInfo(page_index) {
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/course/courseGroupList'); ?>",
		data : {
		...
		success : function(data) {
			if (data["data"].length > 0) {
				...
				for (var i = 0; i < data["data"].length; i++) {
					...
					html +='<td style="text-align: center;"><a href="'+__URL('ADMIN_MAIN/course/updatecoursegroup?group_id='+data["data"][i]['group_id'])+'">修改</a>&nbsp;&nbsp;';	
