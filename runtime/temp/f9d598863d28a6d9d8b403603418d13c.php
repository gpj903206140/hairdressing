<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:39:"template/adminblue\Order\orderList.html";i:1539828328;s:28:"template/adminblue\base.html";i:1545011442;s:45:"template/adminblue\controlCommonVariable.html";i:1530933188;s:32:"template/adminblue\urlModel.html";i:1531183408;s:34:"template/adminblue\pageCommon.html";i:1538099192;s:34:"template/adminblue\openDialog.html";i:1522669943;s:41:"template/adminblue\Order\orderAction.html";i:1524015676;s:47:"template/adminblue\Order\orderRefundAction.html";i:1537520346;s:46:"template/adminblue\Order\orderPrintAction.html";i:1523238980;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
function LoadingInfo(page_index) {
		...
		success : function(data) {
			...
			if (data["data"].length > 0) {
				...
				for (var i = 0; i < data["data"].length; i++) {
                    ...
                    var shipping_time = timeStampTurnTime(data["data"][i]["shipping_time"]);
                    var status="<?php echo $status; ?>";//alert(status+'==='+data["data"][i]["order_status"]);
	...
	// 					html +='<span>订单编号：'+order_no+' 交易号：'+out_trade_no+'</span><span>下单时间：'+create_time+'</span>';
						...
						html += '<div style="font-size: 12px;color: #126AE4;margin-bottom:5px;">';
	// 					html +='<span>订单编号：'+order_no+' 交易号：'+out_trade_no+'</span><span>下单时间：'+create_time+'</span>';
						html +='<span>预约订单编号：'+order_no+'</span>&nbsp;<span>下单时间：'+create_time+'</span>';
						...
						if(data["data"][i]["collect"]!=null){
							...
							//订单数量大于1个，调整样式
							html += '<td><div class="cell" style="display: inline-block;"><span>'+price+'元</span></div><div class="cell" style="display: inline-block;float:right;">人数: '+num+'</div>';
							if(	data["data"][i]["order_item_list"][0]['refund_status'] != 0){
							//退款
							var order_goods_id = data["data"][i]["order_item_list"][0]["order_goods_id"];//订单项id
							var status_name = data["data"][i]["order_item_list"][0]["status_name"];//状态
						...
						html += '<td rowspan="1" style="text-align:center"><div style="text-align:left;"><span class="expressfee">预约时间:</span><br><span class="expressfee">'+shipping_time+'</span><br><span>预留手机号:</span><br><span class="expressfee">'+receiver_mobile+'</span></div></td>';
						...
						if(data["data"][i]["buyer_message"]==''){
                            html += '<td rowspan="'+row+'" style="text-align:center">无</td>';
						}else{
							html += '<td rowspan="1" style="text-align:center"><div style="text-align:left;"><span class="expressfee">备注:</span><br><span class="expressfee">'+data["data"][i]["buyer_message"]+'</span><br></div></td>';
						}
