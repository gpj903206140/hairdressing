...
<div class="ncsc-form-goods">
	...
	<div class="block-basic-setting">
		...
		<dl>
			...
			<dd>
			    <select class="productname input-common" id="course_type">
			        <?php if($goods_info): ?>
                    <option value="0" <?php if($goods_info['course_type'] == 0): ?>selected<?php endif; ?>>线上课程</option>
                    <option value="1" <?php if($goods_info['course_type'] == 1): ?>selected<?php endif; ?>>线下课程</option>
                    <option value="2" <?php if($goods_info['course_type'] == 2): ?>selected<?php endif; ?>>产品课程</option>
                    <?php else: ?>
		...
		<dl>
			...
			<dd>
				<div class="controls">
					<?php if($goods_info): if($goods_info['is_showprice'] == 1): ?>
