<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:51:"template/wap\default_new\Member\memberIndexB2C.html";i:1544494746;s:34:"template/wap\default_new\base.html";i:1544512053;s:38:"template/wap\default_new\urlModel.html";i:1531183592;s:82:"template/wap\default_new\CustomTemplate\controlCommonCustomTemplateBaseFooter.html";i:1520390541;s:36:"template/wap\default_new\footer.html";i:1543281644;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
.member_list ul li a i.icon_about {
    background: url("__TEMP__/<?php echo $style; ?>/public/images/member_icon/about.png") no-repeat;
    background-size: 80% 80%;
}
.member_list ul li a i.icon_help {
    background: url("__TEMP__/<?php echo $style; ?>/public/images/member_icon/help.png") no-repeat;
    background-size: 80% 80%;
}

.panel.memberhead {
    background: url("__TEMP__/<?php echo $style; ?>/public/images/member_icon/top_bg.jpg") no-repeat;
		...
		<a href="javascript:;">
			<p style="margin: 20px 0 10px 0;position:relative;">
				...
				<?php else: ?>
					...
					<!-- <img src="<?php echo __IMG($member_info['user_info']['user_headimg']); ?>" class="lazy_load" data-original="<?php echo __IMG($member_info['user_info']['user_headimg']); ?>"/> -->
				<?php endif; ?>
				</i>
...
<div class="code">
	...
	<a href="<?php echo __URL('APP_MAIN/Distribution/extensionCenter'); ?>">
		<div class="rec" style="position: relative;">
			<span><?php echo lang('distribution_extension_center'); ?></span>
			<span class="jiantou" style="float:right;">
			<?php if($set['is_open'] == 1): ?>
			<img src="__TEMP__/<?php echo $style; ?>/public/images/member_icon/yes_open.png" width="20" height="20">
			<?php else: ?>
            <img src="__TEMP__/<?php echo $style; ?>/public/images/member_icon/no_open.png" width="20" height="20">
			<?php endif; ?>
			</span>
		</div>
	</a>
    <?php else: if($set['is_open'] == 1): ?>
	<a href="<?php echo __URL('APP_MAIN/Distribution/applyPeople'); ?>">
		<div class="rec" style="position: relative;">
			<span><?php echo lang('distribution_application_promoters'); ?></span>
			<span class="jiantou"></span>
		</div>
	</a>
	<?php endif; endif; if($is_promoters == 1): ?>
		<a href="<?php echo __URL('APP_MAIN/Distribution/myTeam'); ?>">
		<div style="width:49%;float:left;padding:10px 0;">
			<img src="__TEMP__/<?php echo $style; ?>/public/images/team2.png" style="width:45px;height:45px; margin: 0 8px 0 20px;float:left;">
			<span>
				<span><?php echo $res['teamNum']; ?>人</span>
				<br>
				<span style="font-size:12px;color: #7B7B7B;"><?php echo lang('distribution_my_team'); ?></span>
			</span>
		</div>
	</a>
	<a href="<?php echo __URL('APP_MAIN/Distribution/myCommission'); ?>">
		<div style="width:50%;float:right;padding:10px 0;">
			<img src="__TEMP__/<?php echo $style; ?>/public/images/yongjin2.png" style="width:45px;height:45px; margin: 0 8px 0 17px;float:left;">
			<span>
				<span><?php echo $res['commission']; ?></span>
				<br>
				<span style="font-size:12px;color: #7B7B7B"><?php echo lang('distribution_my_commission'); ?></span>
			</span>
		</div>
	</a>
	<?php endif; ?>
...
<div class="member_menu_list">
	<ul>
		...
		<!-- <?php if($is_open_virtual_goods > 0): ?>
...
<?php if(is_array($menu_arr) || $menu_arr instanceof \think\Collection || $menu_arr instanceof \think\Paginator): $i = 0; $__LIST__ = $menu_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$arr_item): $mod = ($i % 2 );++$i;?>
	<ul>
		<?php if(is_array($arr_item) || $arr_item instanceof \think\Collection || $arr_item instanceof \think\Paginator): $k = 0; $__LIST__ = $arr_item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;if(!(empty($vo['url']) || (($vo['url'] instanceof \think\Collection || $vo['url'] instanceof \think\Paginator ) && $vo['url']->isEmpty()))): ?>
			<li>
