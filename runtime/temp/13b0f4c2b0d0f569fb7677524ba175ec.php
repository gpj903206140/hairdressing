<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:41:"template/adminblue\Member\memberList.html";i:1546569508;s:28:"template/adminblue\base.html";i:1546935702;s:45:"template/adminblue\controlCommonVariable.html";i:1530933188;s:32:"template/adminblue\urlModel.html";i:1531183408;s:34:"template/adminblue\pageCommon.html";i:1538099192;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="table-class">
	...
	<thead>
		<tr align="center">
			...
			<th style="text-align:left;">推广员编号</th>
...
// 								html += '昵称 : '+data["data"][i]["nick_name"] +'<br/>'+'手机 : '+data["data"][i]["user_tel"]+'<br/>'+'邮箱 : '+data["data"][i]["user_email"];
					...
					if(data["data"][i]["is_promoters"]==1){
					    var	scon=data["data"][i]["number"];
					}else{
                        var	scon='';
					}
					html += '<td style="text-align:right;">' + scon + '</td>';
					html += '<td style="text-align:right;">' + data["data"][i]["point"] + '</td>';
					html += '<td style="text-align:right;">'+'¥'+ data["data"][i]["balance"] +'</td>';
					html += '<td style="text-align:right;">收藏:'+ data["data"][i]["collect_num"] +' 关注:'+ data["data"][i]["follow_num"] +' 分享:'+ data["data"][i]["share_num"] +'</td>';
