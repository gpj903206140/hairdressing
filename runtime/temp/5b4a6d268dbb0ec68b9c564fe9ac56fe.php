<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"template/course\default_new\Courses\video_view.html";i:1545987431;s:39:"template/course\default_new\header.html";i:1545876327;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!-- <div class="kcxqgmfix"><a href="kc_buy.html"><img src="__TEMP__/<?php echo $style; ?>/public/images/goumai.png"></a> </div>
...
<div class="fufeiye">
    ...
    <div class="bkvideo">
        ...
        <!-- <iframe frameborder="0" src="<?php echo $catalogue_info['video_url']; ?>" allowFullScreen="true"
                class="video"></iframe> -->
         <video controls="" autoplay:true name="media"><source src="<?php echo $catalogue_info['video_url']; ?>" type="video/mp4" ></video>
    ...
    <div class="cichusf"><span><?php if($course_info['price'] > 0): ?>此处开始收费<?php else: ?>分享之后可观看<?php endif; ?></span></div>
    <div class="xiaozs gray" style="opacity: 1;">
        ...
        <ul>
            ...
            <li class="<?php if($video['share_num'] == 0): if($uid): ?>show_share<?php else: ?>login_share<?php endif; endif; ?>" data-id="<?php echo $video['video_id']; ?>" data-see="<?php echo $video['try_see']; ?>">
                <?php if($video['teacher_id']): ?>
                <div class="txinform">
                    <div class="l">
                    ...
                    <div class="txname zs"><?php echo $video['teacher_name']; if($video['share_num'] == 0): ?><span>可试看:<?php echo $video['try_see']; ?>分钟</span><?php endif; ?></div>
                </div>
                <?php endif; ?>
                <div class="bkvideo ">
                    <div class="bofang tup"><?php if($video['share_num'] == 0): ?><i class="icon icon-bf"></i><?php endif; ?></div>
                    ...
                    <div class="iframe"><!-- <iframe frameborder="0" src="<?php echo __IMG($video['video_url']); ?>" allowFullScreen="false"
                            class="video"></iframe> --><video controls="" autoplay:true name="media"><source src="<?php echo __IMG($video['video_url']); ?>" type="video/mp4" ></video></div>
                </div>
                <div class="watch <?php if($video['share_num'] > 0): ?>nowatch<?php endif; ?>"></div>
            </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        </a>
        <?php if($lastInfo == ''): ?>
        <a href="javascript:;" class="tjbtn  yj <?php if($last == 0): ?>lastopacity<?php else: ?>yeslastopacity<?php endif; ?>">下一节：没有了</a>
        <?php else: ?>
        <a href="<?php echo __URL('COURSE_MAIN/courses/video_view&goods_id='.$goods_id.'&id='.$lastInfo['catalogue_id']); ?>" class="tjbtn  yj lastLink <?php if($last == 0): ?>lastopacity<?php else: ?>yeslastopacity<?php endif; ?>" data-link="<?php if($last == 0): ?>0<?php else: ?>1<?php endif; ?>">下一节：<?php echo $lastInfo['catalogue_name']; ?></a>
        <?php endif; ?>
    </div>
