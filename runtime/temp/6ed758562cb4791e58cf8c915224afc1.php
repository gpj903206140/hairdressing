<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"template/adminblue\Course\recycleList.html";i:1545293221;s:28:"template/adminblue\base.html";i:1545011442;s:45:"template/adminblue\controlCommonVariable.html";i:1530933188;s:32:"template/adminblue\urlModel.html";i:1531183408;s:34:"template/adminblue\pageCommon.html";i:1538099192;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	...
	<tr>
		...
		<th style="position:relative;">
			...
			<div style="display: inline-block;position: relative;">
				<input type="text" placeholder="请选择课程分类" id="goodsCategoryOne" is_show="false" class="input-common">
			...
			课程名称：<input id="goods_name" class="input-medium input-common" type="text" value="<?php echo $search_info; ?>" placeholder="要搜索的课程名称" >
		...
		<table class="table-class" border="0">
			...
			<tbody>
				<tr class="table-title">
					...
					<th style="text-align: right;">总课数</th>
					<th class="goods-fields-sort" data-field="stock" style="text-align: right;">发布课数<span class="desc"></span></th>
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/course/recyclelist'); ?>",
		data : {
...
// 									html += '</span>';
						...
						html += '<td>';
							html += '<div class="bs-docs-example tooltip-demo"style="text-align: center;">';
								...
								html += '<a href="javascript:regainGoodsDeleted(' + data["data"][i]["goods_id"] + ');" title="恢复课程" style="padding-right:10px;">恢复</a>';
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				$.ajax({
					type : "post",
					url : "<?php echo __URL('ADMIN_MAIN/course/emptydeletecourse'); ?>",
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				$.ajax({
					type : "post",
					url : "<?php echo __URL('ADMIN_MAIN/course/regaincoursdeleted'); ?>",
					data : { "goods_ids" : goods_ids.toString() },
					dataType : "json",
					success : function(data) {
						if(data["code"] > 0 ){
