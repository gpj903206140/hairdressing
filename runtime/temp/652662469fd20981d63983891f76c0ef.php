<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:52:"template/adminblue\course\updateCourseCatalogue.html";i:1545447071;s:28:"template/adminblue\base.html";i:1545011442;s:45:"template/adminblue\controlCommonVariable.html";i:1530933188;s:32:"template/adminblue\urlModel.html";i:1531183408;s:45:"template/adminblue\Course\CourseInputCss.html";i:1545447118;s:34:"template/adminblue\pageCommon.html";i:1538099192;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
.set-style .upload-btn-common>div {
    margin-left: 350px;
}
.upload-btn-common>em {
    left: 350px;
}
.video-thumb>#my-video,.video-thumb  {
    width: 350px !important;
    margin-top: 6px;
    margin-bottom: 8px;
}
...
<div class="set-style">
	<input id="goods_id" type="hidden"value="<?php echo $goods_id; ?>">
	<input id="catalogue_id" type="hidden"value="<?php echo $data['catalogue_id']; ?>">
	<dl>
		<dt><span class="color-red">*</span>课程目录名称：</dt>
		<dd>
			<p><input id="catalogue_name" type="text" value="<?php echo $data['catalogue_name']; ?>" placeholder="请输入课程目录名称" class="input-common"></p>
		...
		<dd>
			<div class="upload-btn-common">
				<div>
					...
					<input type="hidden" id="logo" value="<?php echo $data['catalogue_pic']; ?>" />
				</div>
				<input type="text" id="text_logo" class="input-common" readonly="readonly" value="<?php if($data['catalogue_pic']): ?><?php echo $data['catalogue_pic']; endif; ?>" />
				<em>上传</em>
				
				<img id="preview_logo" src="__STATIC__/blue/img/upload-common-select.png" <?php if($data['catalogue_pic']): ?>data-src="<?php echo __IMG($data['catalogue_pic']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
				...
				<div class="video-thumb">
					<?php if($data['video_url']): ?>
						<video id="my-video" class="video-js vjs-big-play-centered" controls 
							<?php if(empty($data['video_url'])): ?> poster="__STATIC__/blue/img/goods_video_upload_bg.png" <?php else: ?> poster="" <?php endif; ?>
							 src="<?php echo $data['video_url']; ?>">
							<p class="vjs-no-js">To view this video please enable JavaScript, and consider upgrading to a web browser that</p>
						</video>
						<span class="del-video <?php if(empty($data['video_url'])): ?> hide <?php endif; ?>" onclick="del_video(this)"></span>
					<?php else: ?>
    ...
    <dl>
		<dt>输入网址：</dt>
		<dd>
			<input type="text" id="video_url" class="input-common" style="" placeholder="在此输入外链视频地址" value="<?php if($data['video_url']): ?><?php echo $data['video_url']; endif; ?>"/>
			<p class="hint">
...
function updateGoodsCategoryAjax() {
	...
	if(verify(catalogue_name, sort, description)){
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/course/updateCourseCatalogue'); ?>",
			data : {
				'goods_id' : goods_id,
