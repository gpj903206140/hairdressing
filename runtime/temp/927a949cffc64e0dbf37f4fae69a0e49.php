<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:54:"template/adminblue\Course\addCourseCatalogueVideo.html";i:1545976153;s:28:"template/adminblue\base.html";i:1545011442;s:45:"template/adminblue\controlCommonVariable.html";i:1530933188;s:32:"template/adminblue\urlModel.html";i:1531183408;s:45:"template/adminblue\Course\CourseInputCss.html";i:1545447118;s:34:"template/adminblue\pageCommon.html";i:1538099192;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<dd>
			<p>
			 <select id="teacher_id" class="input-common" style="">
                ...
                <?php if(is_array($teacher_list) || $teacher_list instanceof \think\Collection || $teacher_list instanceof \think\Paginator): if( count($teacher_list)==0 ) : echo "" ;else: foreach($teacher_list as $key=>$teacher): ?>
			...
			<input id="catalogue_id" type="hidden" value="<?php echo $catalogue_id; ?>" />
		</dd>
	</dl>
	<!-- <dl>
		<dt>排序：</dt>
...
function addGoodsCategoryAjax() {
	...
	if(verify(video_url)){
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/course/addCourseCatalogueVideo'); ?>",
			data : {
				'goods_id' : goods_id,
				'try_see' : try_see,
			...
			success : function(data) {
				if (data["code"] > 0) {
					...
					setTimeout(function(){location.href = "<?php echo __URL('ADMIN_MAIN/course/CourseCataloguelist'); ?>&goods_id=<?php echo $goods_id; ?>"},1000); 
				}else{
