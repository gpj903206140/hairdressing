<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:48:"template/adminblue\Promotion\couponTypeList.html";i:1536311314;s:28:"template/adminblue\base.html";i:1545011442;s:45:"template/adminblue\controlCommonVariable.html";i:1530933188;s:32:"template/adminblue\urlModel.html";i:1531183408;s:34:"template/adminblue\pageCommon.html";i:1538099192;s:34:"template/adminblue\openDialog.html";i:1522669943;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
			...
			if (data["data"].length > 0) {
				...
				for (var i = 0; i < data["data"].length; i++) {
                    ...
                    if(data["data"][i]["is_show"]==0){
						var is_show = "ADMIN_IMG/close.png";
					}else if(data["data"][i]["is_show"]==1){
						var is_show = "ADMIN_IMG/start.png";
					}
					if(data["data"][i]["is_bespoke"]==0){
						var is_bespoke = "ADMIN_IMG/close.png";
					}else if(data["data"][i]["is_bespoke"]==1){
						var is_bespoke = "ADMIN_IMG/start.png";
					}
					html += '<td align="center"><a href="'+__URL('ADMIN_MAIN/promotion/modifyState?id='+ data['data'][i]['coupon_type_id']+'&name=is_show&state='+data["data"][i]["is_show"])+'" class="editState"><img src="'+is_show+'" width="15" height="15"></a></td>';
					html += '<td align="center"><a href="'+__URL('ADMIN_MAIN/promotion/modifyState?id='+ data['data'][i]['coupon_type_id']+'&name=is_bespoke&state='+data["data"][i]["is_bespoke"])+'" class="editState"><img src="'+is_bespoke+'" width="15" height="15"></a></td>';
