<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:50:"template/course\default_new\Index\class_index.html";i:1546852726;s:39:"template/course\default_new\header.html";i:1545876327;s:39:"template/course\default_new\footer.html";i:1546484966;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="tophei">
    ...
    <div class="mui-scroll-wrapper mui-slider-indicator mui-segmented-control mui-segmented-control-inverted nav">
        <div class="mui-scroll">
            <a href="<?php echo __URL('COURSE_MAIN/Index/Index'); ?>" class="mui-control-item">
                推荐
            </a>
            ...
            <a href="<?php echo __URL('COURSE_MAIN/Index/class_index&category_id='.$vo['category_id']); ?>" class="mui-control-item <?php if($category_id == $vo['category_id']): ?>mui-active<?php endif; ?>">
...
<div class="rush-buy ">
    <div class="cousetop">
        <a href="kc_more.html">
            ...
            <div class="more"><a href="<?php echo __URL('COURSE_MAIN/courses/kc_more&name=is_recommend&category_id='.$category_id); ?>">更多></a></div>
        </a>
    </div>
...
<div class="cousetop">
    <a href="kc_more.html">
        <div class="wzbt">分类课程</div>
        <div class="more"><a href="<?php echo __URL('COURSE_MAIN/courses/kc_more&category_id='.$category_id); ?>">更多></a></div>
    </a>
</div>
<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted cropqh">
    <a class="mui-control-item mui-active" href="#item1" data-type="0">线上课程 </a>
    <a class="mui-control-item" href="#item2" data-type="1">线下课程</a>
</div>
<div class="paixu  clearfix">
    <ul>
        <li><a href="javascript:;" class="mui-active" data-state="0">默认</a></li>
        <li><a href="javascript:;" data-state="1">销量</a></li>
        <li><a href="javascript:;" data-state="2">排序</a></li>
    </ul>
</div>
...
<div class="rush-buy ">
    ...
    <div class="new-course">
        <ul>
           ...
           <li class="wsj" style="display: none" ><img src="__TEMP__/<?php echo $style; ?>/public/images/wtp.png" class=""><br>暂无数据</li> 
        </ul>
    </div>
...
<script>
mui('body').on('tap', '.clearfix ul li a', function () {
    $(".clearfix ul li a").removeClass("mui-active");
    var course_type=$("#segmentedControl .mui-active").attr('data-type');
    $(this).addClass("mui-active");
    var state=$(this).attr('data-state');
    getCourse(1,course_type,state);
})
mui('body').on('tap', '#segmentedControl .mui-control-item', function () {
    var course_type=$(this).attr('data-type');
    var state=$(".clearfix li a.mui-active").attr('data-state');
    getCourse(1,course_type,state);
})
$(function(){
    var course_type=$("#segmentedControl .mui-active").attr('data-type');
...
var page=2;
function getCourse(pages=0,course_type,state){
    if(pages>0){
        page=pages;
    }
    var category_id="<?php echo $category_id; ?>";
    var url="<?php echo __URL('COURSE_MAIN/Index/class_index'); ?>";
    $.post(url,{page_index:page,category_id:category_id,course_type:course_type,state:state},function(data){
          if(data==0){
                if(page==1){
                   $(".new-course ul .content").html("");
                   $(".wsj").show(); 
                }
            }else{
                var myjson='';
                ...
                if(pages==1){
                    ...
                    $(".new-course ul .content").html(html);
                }else{
                    $(".new-course ul .content").append(html);
                }
