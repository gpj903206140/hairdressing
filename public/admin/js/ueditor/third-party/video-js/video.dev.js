...
vjs.options = {
  ...
  'notSupportedMessage': 'Sorry, no compatible source and playback ' +
      ...
      'like <a href="">Chrome</a> or download the ' +
      'latest <a href="">Adobe Flash Player</a>.'
};
  ...
  if (bool !== undefined) {
    ...
    if (bool !== this.userActive_) {
      ...
      if (bool) {
        ...
        // /p/chromium/issues/detail?id=103041
 ...
 * (Parse Method Only)
 * /douglascrockford/JSON-js/blob/master/json2.js
