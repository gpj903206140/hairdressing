...
class System extends BaseController
{
    ...
    public function addAlbumClass()
    {
        ...
        $index_slide = request()->post('index_slide', '');
        $sort = request()->post('sort', 0);
        $album = new Album();
        $retval = $album->addAlbumClass($album_name, $index_slide, $sort, 0, '', 0, $this->instance_id);
        return AjaxReturn($retval);
    }
    ...
    public function updateAlbumClass()
    {
        ...
        $album = new Album();
        $retval = $album->updateAlbumClass($album_id, $aclass_name, $index_slide, $aclass_sort, 0, $album_cover);
        return AjaxReturn($retval);
    }
