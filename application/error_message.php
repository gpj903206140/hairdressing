...
// 分销提现
define("DISTRIBUTION_ZEROERROR", '-9001');
define("DISTRIBUTION_LESSMONEYERROR", '-9002');
...
function getErrorInfo($error_code)
{
    $system_error_arr = array(
        ...
        // 分销提现错误提示
        DISTRIBUTION_ZEROERROR=>'可提现金额少于等于零元！',
        DISTRIBUTION_LESSMONEYERROR=>'佣金提现申请的金额超过了可提现金额或少于等于零元！',
    );
