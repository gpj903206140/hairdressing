 ...
 * **************************************************************版本定义*******************************************************************************
 */
define('NS_VER_B2C', 'NS_VER_B2C'); // 电商
define('NS_VER_B2C_FX', 'NS_VER_B2C_FX'); // 分销
...
define('ADMIN_MODULE', "adminsite"); // 重新定义后台模块
...
return [
    ...
    'view_replace_str' => array(
        ...
        'NAV_IMG' => __ROOT__ . '/public/admin/images/nav',
        ...
        'UPLOAD_ADV' => UPLOAD . '/image_collection/', // //存放广告位图片，由于原“advertising”文件夹名称会被过滤掉。
