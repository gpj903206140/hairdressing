...
/*****************************************************************************************************设置后台登录模块**********************************************************************************/
//检测后台系统模块
     if(ADMIN_MODULE != 'adminsite')
    {
        Route::group(ADMIN_MODULE,function(){
            Route::rule(':controller/:action','adminsite/:controller/:action');
            Route::rule(':controller','adminsite/:controller/index');
            Route::rule('','adminsite/index/index');
          
        });
        Route::group('adminsite',function(){
  ...
  /*     if($show_module == 'shop')
    ...
    $common_route = [
        ...
        '[wap]'  => [
         ...
         '['.ADMIN_MODULE.']'  => [
            ':controller/:action'         => ['adminsite/:controller/:action'],
            ':controller'         => ['adminsite/:controller/index'],
