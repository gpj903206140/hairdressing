...
;(function(root, factory) {
    ...
    function Plyr(media, config) {
        ...
        function _setupStorage() {
            ...
            if (!value) {
                ...
                // version of plyr. See: /Selz/plyr/pull/313
        ...
        function _youTubeReady(videoId, container) {
            ...
            plyr.embed = new window.YT.Player(container.id, {
                ...
                playerVars: {
                    ...
                    modestbranding: 1,
                    disablekb:      1,
                    origin:         '*' // /p/gdata-issues/issues/detail?id=5788#c45
                },
                events: {
                    ...
                    'onStateChange': function(event) {
                        ...
                        switch (event.data) {
                            ...
                            case 1:
                                ...
                                // /Selz/plyr/issues/374
                                // /p/gdata-issues/issues/detail?id=8690
    ...
    function supported(type) {
        ...
        switch (type) {
            ...
            // Issue raised /vimeo/player.js/issues/87
            case 'vimeo':
                basic = true;
                full = (!isOldIE && !isIos);
                break;
