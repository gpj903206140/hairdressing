...
interface IArticle{
    ...
    * @param string $field
    */
   function getArticCommentList($page_index = 1, $page_size = 0, $condition = '', $order = '', $field = '*');
   /**
    * 获取文章详情
   ...
   function addArticle($title, $class_id, $short_title, $source, $url, $author, $summary, $content, $image, $keyword, $article_id_array, $click
       , $sort, $commend_flag, $comment_flag, $comment_examine, $status, $attachment_path, $tag, $comment_count, $share_count,$category,$phone);
   /**
    * 修改文章
    * @param unknown $article_id
    * @param unknown $title
