...
interface IOrder
{
     ...
     */
    function collectMoneyList($page_index = 1, $page_size = 0, $condition = '', $order = 'create_time asc', $field = '*');
    /**
     * 收银金额添加
     *
     ...
     */
    function addContinuedMoney($collect_id, $money, $remark, $create_time);
    /**
     * 收银添加/修改
     *
     * @param unknown $collect_id            
     ...
     * @param unknown $create_time            
     */
    function updateCollectMoney($collect_id, $order_id, $goods_id, $goods_name,$reserve_phone, $order_no, $uid, $nick_name, $money, $meet_money, $coupon_name, $coupon_id, $coupon_money, $at_leasts, $realPayment_money, $payment_method, $accountsWx_money, $paymentDate, $remark, $create_time);
    /**
     * 添加订单
     *
     * @param unknown $data            
