...
interface IAlbum
{
     ...
     */
    function addAlbumClass($aclass_name, $index_slide, $aclass_sort, $pid = 0, $aclass_cover = '', $is_default = 0, $instance_id = 1);
     ...
     * @param number $is_default            
     */
    function updateAlbumClass($aclass_id, $aclass_name, $index_slide, $aclass_sort, $pid = 0, $aclass_cover = '', $is_default = 0);
