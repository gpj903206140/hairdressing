...
class Article extends BaseService implements IArticle
{
     ...
     */
    public function addArticle($title, $class_id, $short_title, $source, $url, $author, $summary, $content, $image, $keyword, $article_id_array, $click, $sort, $commend_flag, $comment_flag, $comment_examine, $status, $attachment_path, $tag, $comment_count, $share_count,$category,$phone)
    {
     ...
     */
    public function updateArticle($article_id, $title, $class_id, $short_title, $source, $url, $author, $summary, $content, $image, $keyword, $article_id_array, $click, $sort, $commend_flag, $comment_flag, $comment_examine, $status, $attachment_path, $tag, $comment_count, $share_count,$category,$phone)
    {
        Cache::tag("article")->clear();
        $member = new Member();
        $user_info = $member -> getUserInfoDetail($this->uid);
