...
class Album extends BaseService implements IAlbum
{
     ...
     */
    public function addAlbumClass($aclass_name, $index_slide, $aclass_sort, $pid = 0, $aclass_cover = '', $is_default = 0, $instance_id = 1)
    {
        $album_class = new AlbumClassModel();
        $data = array(
     ...
     */
    public function updateAlbumClass($aclass_id, $aclass_name, $index_slide, $aclass_sort, $pid = 0, $aclass_cover = '', $is_default = 0)
    {
        $album_class = new AlbumClassModel();
        $data = array(
            'album_name' => $aclass_name,
