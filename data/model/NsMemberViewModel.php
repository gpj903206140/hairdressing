...
class NsMemberViewModel extends BaseModel {
    ...
    public function getViewQuery($page_index, $page_size, $condition, $order)
    {
        ...
        ->field('su.collect_num,su.follow_num,su.share_num,nm.uid, nm.member_level, nm.reg_time, nm.memo, nml.level_name, nml.goods_discount,su.is_promoters,su.number, su.uid, su.instance_id, su.user_name, su.user_password, su.user_status, su.user_headimg, su.is_system, su.is_member, su.user_tel, su.user_tel_bind, su.user_qq, su.qq_openid, su.qq_info, su.user_email, su.user_email_bind, su.wx_openid, su.wx_sub_time, su.wx_notsub_time, su.wx_is_sub, su.wx_info, su.other_info, su.reg_time, su.current_login_ip, su.current_login_time, su.current_login_type, su.last_login_time, su.last_login_ip, su.last_login_type, su.login_num, su.real_name, su.sex, su.birthday, su.location, su.nick_name, su.wx_unionid, su.qrcode_template_id');
